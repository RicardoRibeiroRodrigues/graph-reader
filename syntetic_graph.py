...
class SynteticGraphPipeline:
    ...
    def find_bbox(self, img, thresholded, pad_size_x=30, pad_size_y=30) -> list:
        ...
        top_point = (valid_graph_points[1][top_point],
                     valid_graph_points[0][top_point])
        ...
        for point in dest_points:
            cv2.circle(corrected_image, (int(point[0]), int(
